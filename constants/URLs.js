...
const public_ip_aws_ec2 = 'http://18.228.241.253';
const baseURL = `${public_ip_aws_ec2}:8080`;
...
export const URLs = {
  ...
  changepasswordrequest_url: `${baseURL}/auth/changepasswordrequest`,
  changepassword_url: `${baseURL}/auth/changepassword`,
